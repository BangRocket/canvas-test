<!---
  Cell -  A single amount of space within a Grid/Stage/VCanvas that can be used to render some other
          combination of visual elements (Items, Overlays, Text, etc)

          Handles rendering of cell-location based rendering and layer specific rendering with the cell
  --->
<template>
  <span><slot></slot></span>
</template>
...
export default {
  ...
  methods: {
    ...
    */
    ...
    //     ctx.beginPath()
    //     ctx.lineWidth = '1'
    //     const hitColor = this.hits[value]
